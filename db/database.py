import os
import logging
from sqlalchemy import Column, Integer, String, BigInteger, DateTime, ForeignKey, Index, func, select
...
class Attachment(Base):
    ...
    username = Column(String, nullable=False, default='unknown_user')
...
class Trade(Base):
    ...
    id = Column(Integer, primary_key=True, autoincrement=True)
    user1 = Column(String, nullable=False, default='unknown_user')
    user2 = Column(String, nullable=False, default='unknown_user')
            ...
            async with session.begin():
                ...
                for guild in client.guilds:
                    ...
                    for member in guild.members:
                        stmt = select(Member).where(Member.id == member.id, Member.guild_id == guild.id)
